 ...
 * @argument {string} name - Name of contact
 */
function Contact(user, account, name) {
	...
	/** Returns an array of known Fingerprint instances for this contact.
	 *  @method
	 ...
	 *  @returns {Session} new instance of {@link module:otr.Session Session}
	 */
